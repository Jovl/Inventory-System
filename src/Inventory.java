...
//		File profileTxt = new File("Profile.txt");
		...
		try{
			...
			writer.newLine();
			writer.write(window10.getItemName() + " " + window10.getReqAmount());
			writer.newLine();
			writer.write(admitEnv.getItemName() + " " + admitEnv.getReqAmount());
			writer.newLine();
			writer.write(admitFold.getItemName() + " " + admitFold.getReqAmount());
			writer.newLine();
			writer.write(maps.getItemName() + " " + maps.getReqAmount());
			writer.newLine();
			writer.write(dbPcPennant.getItemName() + " " + dbPcPennant.getReqAmount());
			writer.newLine();
			writer.write(dbPennant.getItemName() + " " + dbPennant.getReqAmount());
			writer.newLine();
			writer.write(engPoster.getItemName() + " " + engPoster.getReqAmount());
			writer.newLine();
			writer.write(intGradBroch.getItemName() + " " + intGradBroch.getReqAmount());
			writer.newLine();
			writer.write(intGradList.getItemName() + " " + intGradList.getReqAmount());
			writer.newLine();
			writer.write(inqCards.getItemName() + " " + inqCards.getReqAmount());
			writer.newLine();
			writer.write(lanyard.getItemName() + " " + lanyard.getReqAmount());
			writer.newLine();
			writer.write(magEnv.getItemName() + " " + magEnv.getReqAmount());
			writer.newLine();
			writer.write(natSecurPoster.getItemName() + " " + natSecurPoster.getReqAmount());
			writer.newLine();
			writer.write(pilotPens.getItemName() + " " + pilotPens.getReqAmount());
			writer.newLine();
			writer.write(presFold.getItemName() + " " + presFold.getReqAmount());
			writer.newLine();
			writer.write(props.getItemName() + " " + props.getReqAmount());
			writer.newLine();
			writer.write(transferBro.getItemName() + " " + transferBro.getReqAmount());
			writer.newLine();
			writer.write(travPiece.getItemName() + " " + travPiece.getReqAmount());
			writer.newLine();
			writer.write(viewBook.getItemName() + " " + viewBook.getReqAmount());
			writer.newLine();
			writer.write(viewBkEnv.getItemName() + " " + viewBkEnv.getReqAmount());
			writer.newLine();
